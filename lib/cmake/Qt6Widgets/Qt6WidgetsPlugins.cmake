...
include("${CMAKE_CURRENT_LIST_DIR}/Qt6QWindowsVistaStylePluginConfig.cmake")
...
if(NOT OFF)
    ...
    foreach(target QWindowsVistaStylePlugin)
        ...
        set(_generated_qt_plugin_file_name
            "${CMAKE_CURRENT_BINARY_DIR}/qt_Widgets_${target}.cpp")
